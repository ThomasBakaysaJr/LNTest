...
try:
    command = [f"bitcoin-cli", f"-rpcuser={rpc_user}", f"-rpcpassword={rpc_password}", "generatetoaddress", "201", f"{address}"]
    while True:        
        command = [f"bitcoin-cli", f"-rpcuser={rpc_user}", f"-rpcpassword={rpc_password}", "generatetoaddress", "12", f"{address}"]
